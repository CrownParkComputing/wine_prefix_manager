...
class LogService {
  ...
  Future<void> initialize() async {
    try {
      ...
      // Log initialization *after* setting the path, so this message goes to the file too
      log('LogService initialized. Log file: $_logFilePath', LogLevel.info);
    } catch (e) {
      // debugPrint('Failed to initialize LogService: $e');
      log('Failed to initialize LogService: $e', LogLevel.error); // Also log the error
    }
  }
