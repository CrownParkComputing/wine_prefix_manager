...
class _GameDetailsPageState extends State<GameDetailsPage> with SingleTickerProviderStateMixin {
      ...
      bottomNavigationBar: Container(
        ...
        child: Row(
          children: [
            ...
            IconButton(
              onPressed: () => _showChangePrefix(context),
              icon: const Icon(Icons.swap_horiz),
              tooltip: 'Change Prefix',
            ),
          ],
        ),
      ),
  ...
  void _showChangePrefix(BuildContext context) {
    showDialog(
      context: context,
      builder: (context) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            const Text('Select a new prefix for this game:'),
            const SizedBox(height: 16),
            DropdownButtonFormField<WinePrefix>(
              value: widget.game.prefix,
              items: widget.availablePrefixes.map((prefix) => DropdownMenuItem(
                value: prefix,
